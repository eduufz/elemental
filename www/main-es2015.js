...
const routes = [
    ...
    {
        path: 'leaderboards',
        loadChildren: () => __webpack_require__.e(/*! import() | leaderboards-leaderboards-module */ "leaderboards-leaderboards-module").then(__webpack_require__.bind(null, /*! ./leaderboards/leaderboards.module */ "./src/app/leaderboards/leaderboards.module.ts")).then(m => m.LeaderboardsPageModule)
    },
    {
        path: 'tab1',
