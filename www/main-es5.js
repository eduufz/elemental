...
module.exports = "<ion-app>\n  <ion-split-pane contentId=\"main-content\">\n    <ion-menu contentId=\"main-content\" type=\"overlay\" [disabled]=\"!this.auth.isLoggedIn\">\n      <ion-header>\n        <ion-toolbar>\n          <ion-title>Menu</ion-title>\n        </ion-toolbar>\n      </ion-header>\n      <ion-content>\n        <ion-list>\n\n          <ion-menu-toggle auto-hide=\"false\" *ngFor=\"let p of appPages\">\n            <ion-item [routerDirection]=\"'root'\" [routerLink]=\"[p.url]\">\n              <ion-icon slot=\"start\" [name]=\"p.icon\"></ion-icon>\n              <ion-label>\n                {{p.title}}\n              </ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n\n        </ion-list>\n      </ion-content>\n    </ion-menu>\n    <ion-router-outlet id=\"main-content\"></ion-router-outlet>\n  </ion-split-pane>\n</ion-app>\n"
...
var routes = [
    ...
    {
        path: 'leaderboards',
        loadChildren: function () { return __webpack_require__.e(/*! import() | leaderboards-leaderboards-module */ "leaderboards-leaderboards-module").then(__webpack_require__.bind(null, /*! ./leaderboards/leaderboards.module */ "./src/app/leaderboards/leaderboards.module.ts")).then(function (m) { return m.LeaderboardsPageModule; }); }
    },
    {
        path: 'tab1',
        loadChildren: function () { return Promise.all(/*! import() | tab1-tab1-module */[__webpack_require__.e("default~tab1-tab1-module~tab2-tab2-module"), __webpack_require__.e("tab1-tab1-module")]).then(__webpack_require__.bind(null, /*! ./tab1/tab1.module */ "./src/app/tab1/tab1.module.ts")).then(function (m) { return m.Tab1PageModule; }); }
    },
    {
        path: 'tab2',
        loadChildren: function () { return Promise.all(/*! import() | tab2-tab2-module */[__webpack_require__.e("default~tab1-tab1-module~tab2-tab2-module"), __webpack_require__.e("tab2-tab2-module")]).then(__webpack_require__.bind(null, /*! ./tab2/tab2.module */ "./src/app/tab2/tab2.module.ts")).then(function (m) { return m.Tab2PageModule; }); }
    },
];
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.login = function (credentials) {
        ...
        if (credentials.email === null || credentials.password === null) {
            return rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"].throw("Please insert credentials");
        }
        else {
            return rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"].create(function (observer) {
                _this.isLoggedIn = true;
                console.log("Logeado?: ", _this.isLoggedIn);
                // At this point make a request to your backend to make a real check!
                var access = (credentials.password === "123" && credentials.username === "eabol");
                _this.currentUser = new User('eabol', 'eabol@bestteameaver.es');
...
module.exports = __webpack_require__(/*! /home/eabol/elemental/src/main.ts */"./src/main.ts");
